...
if (isset($_POST["submit"])) {
    ...
    if(mysqli_num_rows($result) > 0){
        if($password == $row["password"]){
            ...
            echo
            "<script> alert('Wrong Password')</sript>";
        }

    } else {
        echo
        "<script> alert('User Not Registered')</sript>";
    }
}
?>
...
<form class="login" action="" method="post" autocomplete="off">
    ...
    <div class="avatar"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50"  fill="currentColor" class="person" viewBox="0 0 16 16">
    ...
    <h2>Login</h2>
        ...
        <button class="btn-login" type="submit" name="submit">Login</button><br><br>

        <div class="bottom">
            Belum punya akun? <a href="registration.php">Register</a>
        </div>
    </form>
    <br>
